    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    <label className="block text-white/80 text-sm font-medium mb-2">Monthly Budget (USD)</label>
                    <input
                        type="number"
                        name="monthlyBudget"
                ...
                <div>
                    <label className="block text-white/80 text-sm font-medium mb-2">Per Project Budget (USD)</label>
                    <input
                        type="number"
                        name="projectBudget"
            ...
            <div>
                ...
                <select
                    ...
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:border-green-400 transition-colors"
                >
                    <option value="" className="bg-gray-800">When do you prefer to pay?</option>
                    <option value="upfront" className="bg-gray-800">100% Upfront</option>
                    <option value="milestone" className="bg-gray-800">Milestone-based payments</option>
                    <option value="weekly" className="bg-gray-800">Weekly payments</option>
                    <option value="completion" className="bg-gray-800">Upon project completion</option>
                    <option value="hourly" className="bg-gray-800">Hourly payments</option>
                </select>
            </div>
