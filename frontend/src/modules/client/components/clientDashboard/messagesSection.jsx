...
// // Payment message component (modified for client side)
// const PaymentMessage = ({ amount, description, status, isRequest, onPayment }) => (
//     <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-lg p-4 max-w-xs">
//         <div className="flex items-center justify-between mb-2">
//             <div className="flex items-center space-x-2">
...
// // Attachment menu component (removed payment request option)
// const AttachmentMenu = ({ isVisible, onClose, onFileSelect, onVoiceRecord }) => {
...
//         <div
//             id="attachment-menu"
//             className="absolute bottom-full mb-2 right-0 bg-gray-800 border border-white/20 rounded-lg p-2 shadow-lg z-50 w-48 grid grid-cols-3 gap-2"
//             role="menu"
...
// const PaymentModal = ({ isVisible, paymentData, onClose, onConfirm }) => {
//     if (!isVisible) return null;
...
//                         <div className="flex items-center space-x-2">
//                             <DollarSign size={20} className="text-green-400" />
//                             <span className="text-white font-bold text-lg">${paymentData?.amount}</span>
//                         </div>
//                         <span className="px-3 py-1 bg-yellow-500/20 text-yellow-300 rounded-full text-sm">
//                             {paymentData?.status}
//                         </span>
//                     </div>
//                     <p className="text-white/80 text-sm mb-4">{paymentData?.description}</p>
//                     <div className="space-y-2 text-sm text-white/70">
//                         <div className="flex justify-between">
//                             <span>Amount:</span>
...
//                         <div className="flex justify-between font-medium">
//                             <span>Total:</span>
//                             <span className="text-white">${(paymentData?.amount + 2.5).toFixed(2)}</span>
//                         </div>
//                     </div>
//                 </div>
//                 <div className="flex space-x-3">
...
//                 status: 'pending',
//                 isRequest: true,
//                 onPayment: () => { } // Will be handled by modal
//             }
//         }
//     ]);
//     const [newMessage, setNewMessage] = useState('');
...
//         // Update the payment status in messages
//         setMessages(prev => prev.map(msg => {
//             if (msg.type === 'payment' && msg.paymentData?.amount === selectedPayment?.amount) {
//                 return {
//                     ...msg,
...
//     // Enhanced messages with payment click handler
//     const enhancedMessages = messages.map(msg => {
//         if (msg.type === 'payment' && msg.paymentData) {
//             return {
//                 ...msg,
//                 paymentData: {
//                     ...msg.paymentData,
//                     onPayment: () => handlePaymentClick(msg.paymentData)
//                 }
//             };
//         }
//         return msg;
...
//                                     )}
//                                     <div className="relative">
//                                         <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center text-white font-medium select-none">
//                                             {selectedChat.avatar}
//                                         </div>
//                                         {selectedChat.online && (
...
//                                         id="attach-btn"
//                                         onClick={() => setShowAttachmentMenu(v => !v)}
//                                         className="text-gray-400 hover:text-white transition-colors p-2 rounded-full touch-manipulation focus:outline-none focus:ring-2 focus:ring-blue-400"
//                                         aria-haspopup="true"
...
//                                     placeholder={isRecording ? "Recording voice..." : "Type a message..."}
//                                     className="flex-1 bg-white/10 text-white px-4 py-3 rounded-lg border border-white/20 focus:outline-none focus:border-blue-500 text-base"
//                                     disabled={isRecording}
...
//                                             className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white p-2 rounded-lg hover:from-blue-600 hover:to-cyan-600 transition-all duration-200 touch-manipulation focus:outline-none"
//                                             aria-label="Send message"
//                                             type="button"
//                                         >
//                                             <Send size={16} />
