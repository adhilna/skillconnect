          ...
          `}
                ...
                <div className="flex items-center justify-between mb-3 text-white/80 text-sm">
                    <div className="flex items-center gap-1">
                        ...
                        <span className="text-emerald-400 font-bold">{amountRange}</span>
                    </div>
                    <div>
                        <span>Delivery: </span>
                        <span className="font-medium">{timelineDays} days</span>
                    </div>
                </div>
                ...
                {message && (
                    <div className="mb-3 p-3 bg-slate-800/40 rounded-lg border border-slate-600/20">
                        <div className="flex items-center mb-1">
                            ...
                            <span className="text-slate-300 text-sm font-medium">Freelancer Message</span>
                        </div>
