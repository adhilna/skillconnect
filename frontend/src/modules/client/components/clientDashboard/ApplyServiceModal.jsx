...
const ApplyServiceModal = ({ service, visible, onCancel, onSubmit }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="bg-gray-900 rounded-lg shadow-lg max-w-md p-6 w-full mx-4">
                <h3 className="text-white text-xl mb-4">
                    Apply for <span className="font-semibold">{service.title}</span>
                </h3>

                <textarea
                    className="w-full p-3 rounded-md bg-gray-800 border border-gray-700 text-white resize-none"
                    rows={4}
                    placeholder="Write your message to the freelancer (optional)..."
                    value={message}
