        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            ...
            <div>
                ...
                <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder:text-white/50 focus:outline-none focus:border-blue-400 transition-colors text-sm sm:text-base"
                    placeholder="Doe"
                />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <div className="sm:col-span-1 lg:col-span-1">
                ...
                <input
                    ...
                    placeholder="Country"
                />
                {fieldErrors.country && <p className="text-red-400 text-xs sm:text-sm mt-1">{fieldErrors.country}</p>}
            </div>
...
//                 <div className="relative">
//                     <label className="w-24 h-24 rounded-full bg-white/10 flex items-center justify-center overflow-hidden border-2 border-white/20 cursor-pointer">
//                         {freelancerData.profile_picture_preview ? (
//                             <img src={freelancerData.profile_picture_preview} alt="Profile" className="w-full h-full object-cover" />
//                         ) : (
...
//                             className="hidden"
//                         />
//                         <Upload size={32} className="text-white absolute bottom-0 right-0 bg-blue-500 rounded-full p-2" />
//                         {fieldErrors.profile_picture && (
...
//                         placeholder="25"
//                     />
//                     {fieldErrors.age && <p className="text-red-400 text-sm mt-1">{fieldErrors.age}</p>}
//                 </div>
//             </div>
...
//                     placeholder="Tell us about yourself, your experience, and what makes you unique..."
//                 />
//                 {fieldErrors.about && <p className="text-red-400 text-sm mt-1">{fieldErrors.about}</p>}
//             </div>
//         </div>
//     );
// }