        ...
        <div className="relative" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="absolute right-0 mt-3 w-80 sm:w-96 max-h-[32rem] 
                               backdrop-blur-xl bg-gradient-to-br from-purple-900/95 via-purple-800/90 to-indigo-900/95
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-white/15 via-purple-300/5 to-transparent 
